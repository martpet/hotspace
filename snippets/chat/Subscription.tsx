...
export default function Subscription(_: unknown, ctx: AppContext) {
  ...
  if (
    ...
    help =
      `Notifications for new messages appear when ${browser.name} is closed, or when this tab is closed, or when another tab is focused.`;
  } else {
    help =
      `Notifications for new messages appear when ${browser.name} is running and this tab is closed or another tab is focused.`;
  }
